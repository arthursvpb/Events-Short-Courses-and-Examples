...
const CLIENT_ID = '17e6248a539b0e190a46';
...
type AuthProviderProps = {
  children: React.ReactNode; // Qualquer coisa aceitável pelo React
};
...
// Código retornado pelo github pelo params
  ...
  async function signIn() {
    try {
      ...
      if (
        ...
        // Definir cabeçalho de todas as requisições
